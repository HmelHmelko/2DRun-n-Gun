...
public class DropShadow : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        int count = Physics2D.Raycast((Vector2)playerRef.transform.position + Vector2.up * originOffset, Vector2.down, m_ContactFilter, m_ContactCache);
        ...
        if (count > 0)
        {
            ...
            float height = Vector3.SqrMagnitude(playerRef.transform.position - transform.position);
